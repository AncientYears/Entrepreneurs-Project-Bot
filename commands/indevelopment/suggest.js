...
module.exports.run = async (client, message, args) => {
	...
	const suggest = new discord.MessageEmbed().setDescription(args.join(' ')).setColor('RANDOM').setAuthor('Suggestion', client.user.displayAvatarURL, `https://discordapp.com/users/${message.author.id}`);
