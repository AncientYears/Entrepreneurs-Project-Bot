...
`);
			...
			message.reply(client.format(`You have located your business in: **${args[0].toLowerCase()} area**!\nFantastic, you have successfully setup your business and earned **$100**!\nNow, in the <mainserverinvite> server, run the **${client.prefix}help** command to find the commands to start running your business!\n\nAlso if you need any further help, there is a great community in that server to answer all of your questions! :joy_cat:`));
